...
.sobre2 {
 ...
 border:none;
  ...
  <div id="chistes">
  <img src="credencial/Cred1.7.png" width="318" hspace="16" height="468" vspace="56" />
  <?php
  echo '<img class="sobre" src="'.$row['foto'].'" width="168" height="206" hspace="96" vspace="186"/>';
   ?>
  </div>
  <div id="chistes2">
  <img class="sobre2" src="credencial/Cred1.8.png" width="318" hspace="346" height="468" vspace="82" />

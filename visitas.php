...
$query= "SELECT * FROM visitas WHERE correo='".$_SESSION['u_usuario']."'";
...
.sobre2 {
 ...
 border:none;
  ...
  <body>
  <a href="salir.php">Regresar</a>
  <div id="chistes">
  <img src="credencial/Cred1.5.png" width="318" hspace="16" height="468" vspace="56" />
  <?php
  echo '<img class="sobre" src="'.$row['foto'].'" width="168" height="206" hspace="96" vspace="186"/>';
   ?>
  </div>
  <div id="chistes2">
  <img class="sobre2" src="credencial/Cred1.6.png" width="318" hspace="346" height="468" vspace="82" />
  ...
  <div class="centrado"><?php echo $row['eqv']?></div>
